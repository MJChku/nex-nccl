...
// External CUDA Driver API functions for NEX interception
...
// Note: These function pointer declarations are commented out since we use external declarations
// All the DECLARE_CUDA_PFN_EXTERN calls are commented out since we use external declarations
/*
